...
object Templates {
    ...
    private fun parseLayout(json: JSONObject?): TemplateLayoutConfig {
        ...
        return TemplateLayoutConfig(
            ...
            tiltMode = json.optString("tiltMode", "axis"),
            yawRange = json.optFloat("yawRange", 0.65f),
            flatnessStart = json.optFloat("flatnessStart", 0.45f),
            flatnessEnd = json.optFloat("flatnessEnd", 0.75f),
            recenterOnScreenOn = json.optBoolean("recenterOnScreenOn", true),
